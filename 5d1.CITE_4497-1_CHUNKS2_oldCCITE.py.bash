...
for sample in ${samples[@]};do
	...
	cat $rawDir"/CITE_fastqs/raw/backup/"*R1* > $inDir$sample"_CITESEQ_S1_R1_L001_old.fastq.gz"
	cat $rawDir"/CITE_fastqs/raw/backup/"*R2* > $inDir$sample"_CITESEQ_S1_R2_L001_old.fastq.gz"
	...
	qsub -q short.q -hold_jid gzip -b y -j y -N CITE_$sample -wd $logDir -pe smp 12 -V "python /share/ScratchGeneral/nenbar/local/lib/CITE-seq-Count/CITE-seq-count.py -R1 $inDir$sample"_CITESEQ_S1_R1_L001_old.fastq.gz" -R2 $inDir$sample"_CITESEQ_S1_R2_L001_old.fastq.gz" -t $inDir"tags.csv" -cbf 1 -cbl 16 -umif 17 -umil 26 -tr \"^[ATGC]{15}[TGC][A]{6,}\" -hd 1 -o $inDir$sample"_emptydrop_CITE_old.tsv" -wl $inDir$sample\"_emptydrop_whitelist.txt\""
