...
finalObject<-paste0(RobjectsDir,"03_seurat_CCA_aligned_processed_44971.Rdata")
...
DoHeatmap(citeCells1, features = unique(adt.markers$gene),raster=T, assay = "ADT", angle = 90,group.by="garnett_call_ext_major") + NoLegend()
dev.off()
