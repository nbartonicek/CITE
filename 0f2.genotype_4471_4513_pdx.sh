...
type="_PDX"
projectname=$projectnameSample"_PDX"
...
(echo cel_files; grep $step1Dir/"cel_list1.txt" -v -f $step1Dir/"failed.txt" | grep 'A12\|A31' | grep '4471\|4513') >$step1Dir/"cel_list2.txt"
...
projectnameSample=$sample1"_"$sample2
type="_Blood"
projectname=$projectnameSample"_Blood"
