...
#get the files
#id=4513
#cp /paella/TumourProgressionGroupTemp/projects/data/cellranger_count/human_breast/CID$id/count_CID"$id"_GRCh38/outs/possorted_genome_bam.bam* . &
#mv possorted_genome_bam.bam $id.bam
#mv possorted_genome_bam.bam.bai $id.bam.bai

#id=4530
#cp /paella/TumourProgressionGroupTemp/projects/data/cellranger_count/human_breast/CID$id/count_CID"$id"_GRCh38/outs/possorted_genome_bam.bam* . &
#mv possorted_genome_bam.bam 4513.bam
#mv possorted_genome_bam.bam.bai $id.bam.bai
...
for i in {0..5};do
	qsub -q short.q -b y -j y -N demuxlet -wd $logDir -pe smp 10 -P TumourProgression -V demuxlet --doublet-prior 0.$i --sam /share/ScratchGeneral/nenbar/projects/CITE/raw_files/4513_4530/outs/possorted_genome_bam.RG.bam --vcf $inFolder"/merge_overlapped_fullheader.vcf" --field GT --group-list /share/ScratchGeneral/nenbar/projects/CITE/raw_files/4513_4530/outs/barcodes.tsv --out $outFolder"/overlapped_doubletprior_0."$i
done
