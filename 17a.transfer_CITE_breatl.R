...
save(query.anchors,file=paste0(RobjectsDir,"query.anchors.Rdata"))
...
pdf(paste0(figDir,"CITE_imputed_subsetAtlas_int_cluster_subset_PC_C_res.1.2_ridgeplot.pdf"),width=8,height=32)
