...
type="CITE"
sampleNames=( "SVH130918A_control" "3921_3963_4066" "4497-1" "4497-2" "4290B" "4515" "4530-N" "4530-T" "ETIMAS_S21" "ETIMAS_S22" "ETIMAS_T21" "ETIMAS_T22" "MIA" "pool1" "TONS_PBMC" )
#sampleNames=( "4T1_3x" )
method="umis"
...
#samples=( "3921_3963_4066" )
	...
	qsub -q short.q -hold_jid gzip -b y -j y -N $type$sampleName -wd $logDir -pe smp 20 -P DSGClinicalGenomics -V "CITE-seq-Count -T 10 -R1 "$R1" -R2 "$R2" -t "$inDir"tags.csv -cbf 1 -cbl 16 -umif 17 -umil $umil -o "$inDir$sampleName"_"$type".v3 -cells "$cellNum" -wl "$whitelist 
	method="reads"
