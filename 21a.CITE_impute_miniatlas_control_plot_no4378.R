...
SSsampleNames_CITE<-SSsampleNames[grepl("3838|3946|4040|4515",SSsampleNames)]
...
ABsList<-list()
ABsListNorm<-list()
ABsListFile<-paste0(RobjectsDir,"ABsListNo4378.Rdata")
ABsListNormFile<-paste0(RobjectsDir,"ABsListNormNo4378.Rdata")

#for each sample extract data
workingCITE<-list()
workingCITEFile<-paste0(RobjectsDir,"workingCITENo4378.Rdata")
workingCITENorm<-list()
workingCITENormFile<-paste0(RobjectsDir,"workingCITENormNo4378.Rdata")
