...
#for(treatment in treatments){
  ...
  dataM <- paste0("/share/ScratchGeneral/sunwu/Chromium_10X/count_data_2/CID4530",tag,"/count_CID4520",tag,"_GRCh38_mm10/outs/raw_gene_bc_matrices/mm10")
  ...
  if(!file.exists(seuratMatCleanObject)){
    ...
    #add the HASH data
    #reverse tag
    if(treatment=="normal"){tag=""}else{tag="-N"}
  ...
  pdf(paste0(figDir,"feature_plot_hash_",sampleName,".pdf"),width=12,height=4)
