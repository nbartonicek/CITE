...
#samples=( "3921_3963_4066" )
	...
	qsub -q short.q -hold_jid gzip -b y -j y -N $type$sampleName -wd $logDir -pe smp 50 -V "CITE-seq-Count -T 25 -R1 "$R1" -R2 "$R2" -t "$inDir"tags.csv -cbf 1 -cbl 16 -umif 17 -umil $umil -o "$inDir$sampleName"_"$type".v3 -cells "$cellNum" -wl "$whitelist 
	method="reads"
