...
projectname="miniatlas_normal"
sampleName="miniatlas_normal"
treatment="v3"
...
pdf(paste0(figDir,"CITE_original_miniatlas_normal_feature_ADT.pdf"),width=12,height=16)
...
save(cite,file=paste0(RobjectsDir,"imputed_cite_normal.Rdata"))
...
saveRDS(integrated.data,file=paste0(RobjectsDir,"miniatlas_normal_4378N-imputed-CITE.Rdata"))

pdf(paste0(figDir,"CITE_imputed_miniatlas_feature_ADT_normal.pdf"),width=12,height=48)
FeaturePlot(object = citeCells1, features = row.names(citeCells1$ADT@data), reduction="UMAPC",min.cutoff = "q05", max.cutoff = "q95", ncol = 4)
dev.off()
...
pdf(paste0(figDir,"CITE_annotated_umap_samples_normal.pdf"),width=12,height=8)
DimPlot(object = citeCells1, reduction="UMAPC",label = T,group.by="garnett_call_ext_major")
dev.off()


pdf(paste0(figDir,"CITE_annotated_umap_samples_split_normal.pdf"),width=12,height=8)
