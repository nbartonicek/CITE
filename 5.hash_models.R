...
if(!file.exists("../project_results/Robjects/Human_HASHSEQ_S1_hd2_F_seuratMatClean.Rdata")){
  ...
  save(seuratMatClean,file="../project_results/Robjects/Human_HASHSEQ_S1_hd2_F_seuratMatClean.Rdata")
}else{
  load("../project_results/Robjects/Human_HASHSEQ_S1_hd2_F_clean.Rdata")
  load("../project_results/Robjects/Human_HASHSEQ_S1_hd2_F_seuratMatClean.Rdata")
}

if(!file.exists(paste0(rObjectsDir,"hashedCells.Rdata"))){
  ...
  save(hashedCells,file=paste0(rObjectsDir,"hashedCells.Rdata"))
} else {load(paste0(rObjectsDir,"hashedCells.Rdata"))}
#do the hashing
...
save(hashedCells,file=paste0(rObjectsDir,"hashedCells_with_HTO.Rdata"))
