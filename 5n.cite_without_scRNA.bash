...
type="CITE"
sampleNames=( "3838" "3946" "4040" "PBMC" "Tonsil" )
sampleNames=( "3946" )
method="umis"
for sampleName in ${sampleNames[@]};do
	logDir="/share/ScratchGeneral/nenbar/projects/CITE/scripts/logs"
	rawDir="/share/ScratchGeneral/nenbar/projects/CITE/raw_files/trial/$sampleName"

#samples=( "3921_3963_4066" )
	inDir="/share/ScratchGeneral/nenbar/projects/CITE/raw_files/trial/$sampleName/"
	...
	#qsub -q short.q -hold_jid gzip -b y -j y -N $type$sampleName -wd $logDir -pe smp 20 -V "CITE-seq-Count -T 10 -R1 "$R1" -R2 "$R2" -t "$inDir"tags.csv -cbf 1 -cbl 16 -umif 17 -umil $umil -o "$inDir$sampleName"_"$type".v3 -cells "$cellNum" -wl "$whitelist 
	method="reads"
